...
ROMAN: Dict[str, str] = {
    ...
    "hero_preview_alt": "Sahulat ke nateeje ki jhalak: aik mauqa, janchi gayi sharait, aur agla qadam.",
    "hero_preview_note": "Yeh hamari fehrist se haqeeqi nateeja hai, namoona profile par jancha gaya - koi tasveeri namoona nahi.",
